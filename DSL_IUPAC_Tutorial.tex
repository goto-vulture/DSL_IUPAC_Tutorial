...
$P_2$ can only be reached, if at least one times $pc$ was produced. So the usage of the nonterminal $P_2$ itelf holds the information, that a summary prefix must be used. \ref{fig:NewStyleMultiplePositions} shows the modified visualization of $P$.
